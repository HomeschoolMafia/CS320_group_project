...
class IndexView(FlaskView):
    ...
    def get(self):
        ...
        catalog = Catalog(search_text, search_archived=search_archived, select_provided=search_projType,
                          search_grade=search_grade, max_ProjSize=search_projSize, 
                          electrical=search_electrical, mechanical=search_mechanical,
